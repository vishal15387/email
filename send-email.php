...
$from       = "message from sdfsdf";
$vishal  = "vishalrathod86@gmail.com"; //It's mail info@example.com
$to         = "vishalrathod86@gmail.com"; // where you want to get mail 
$subject    = " Contact Us From vision computers .";

$headers    = "From: " . $from . "<" . $vishal . ">\r\n";
